...
export default function Home() {
    ...
    const onSubmit = (data) => {
        console.log(data);
        navigate(`/results?query=${encodeURIComponent(data.Search)}`);
    };
    return (
        <>
